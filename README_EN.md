...
✅ Skips unqualified candidates instantly, digs into promising ones
✅ Sends outreach messages to qualified candidates automatically
✅ Follows up immediately with resume/portfolio requests
✅ Pauses and asks you when it hits an edge case
✅ Reports progress periodically, never contacts the same person twice
✅ Works on BOSS直聘, 猎聘, 智联招聘, 拉勾, and similar platforms
...
A: BOSS直聘 (verified), 猎聘, 智联, 拉勾, and similar job platforms.
